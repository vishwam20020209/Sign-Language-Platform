...
const Collaboration = () => {
  const handleTryItNowClick = () => {
    ...
    window.location.href = './ISL CHATBOT/index2.html'; // Adjust the path if it's located somewhere else
  };
      ...
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="h2 mb-4 md:mb-8">
            AI Based ChatBot For Seamless Interaction
          </h2>
          ...
          <Button onClick={handleTryItNowClick}>Use AI Chatbot</Button>
        </div>
